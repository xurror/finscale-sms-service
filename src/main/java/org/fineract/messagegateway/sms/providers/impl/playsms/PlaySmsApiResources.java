...
@RestController
@RequestMapping("/playsms")
public class PlaySmsApiResources {

  private static final Logger logger = LoggerFactory.getLogger(PlaySmsApiResources.class);

  private final SmsOutboundMessageRepository smsOutboundMessageRepository ;

  @Autowired
  public PlaySmsApiResources(final SmsOutboundMessageRepository smsOutboundMessageRepository) {
